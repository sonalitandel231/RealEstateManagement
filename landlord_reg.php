	   ...
	   <div class="">
                       ...
                       <center>
						<form class="" role="form" action="land_register.php" method="POST">
						    ...
						    <br>
						    <div class="col-lg-10">
						      <input type="tel" class="form-control" id="text1" placeholder="Enter Your Phone Number" required="required" name="phone" pattern="[7-9]{1}[0-9]{9}">
						    </div>
						    <br>
						    <br>
						    <div class="col-lg-10">
						    ...
						    <br>
						     <div class="col-lg-10">
						      <input type="password" class="form-control" id="text1" placeholder="Enter Password You Will Use For Login" required="required" name="password" pattern="(?=.\d)(?=.[a-z])(?=.*[A-Z]).{8,}">
						    </div>
                            <br>
						    <br>
                        </tr>
		...
		<div id="footerwrap">
			<div class="container">
				<h4>Created With Love by <a href="https://www.facebook.com/blairt94/">Shraddha and Ramya</a> - Copyright 2018</h4>
			</div>
